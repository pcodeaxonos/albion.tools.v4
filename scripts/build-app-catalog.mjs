...
const siteTools = [
    ...
    { id: 4, code: 'island-planner', title: 'Ada Planlayıcı', description: 'İstikrarlı gümüş/gün; sade vs zincir; faction kilit.', icon: '🏝️', href: 'island-planner.html', addedAt: '2026-09-07', groupLabel: 'Ada', frequent: true, sortValue: 40, isActive: true },
